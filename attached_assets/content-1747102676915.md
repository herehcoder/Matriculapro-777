[Skip to main content](https://docs.mistral.ai/capabilities/document/#__docusaurus_skipToContent_fallback)
...
## FAQ [​](https://docs.mistral.ai/capabilities/document/\#faq "Direct link to FAQ")

### Are there any limits regarding the OCR API? [​](https://docs.mistral.ai/capabilities/document/\#are-there-any-limits-regarding-the-ocr-api "Direct link to Are there any limits regarding the OCR API?")
...
- [Document OCR processor](https://docs.mistral.ai/capabilities/document/#document-ocr-processor)
  - [OCR with PDF](https://docs.mistral.ai/capabilities/document/#ocr-with-pdf)
  - [OCR with uploaded PDF](https://docs.mistral.ai/capabilities/document/#ocr-with-uploaded-pdf)
  - [OCR with image](https://docs.mistral.ai/capabilities/document/#ocr-with-image)
- [Document understanding](https://docs.mistral.ai/capabilities/document/#document-understanding)
- [Cookbooks](https://docs.mistral.ai/capabilities/document/#cookbooks)
- [FAQ](https://docs.mistral.ai/capabilities/document/#faq)
  - [Are there any limits regarding the OCR API?](https://docs.mistral.ai/capabilities/document/#are-there-any-limits-regarding-the-ocr-api)